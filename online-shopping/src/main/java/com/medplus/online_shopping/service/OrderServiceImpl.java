...
public class OrderServiceImpl implements OrderService{
	...
	public List<OrderList> getAllOrderList(int offset,int range) {
		Page<OrderList> orderList= orderListDao.findAll(PageRequest.of(offset, range));
...
//		order.setZipCode(customerService.getCustomerAddress(customerId).get(0).getZipCode());
		...
		return "Order has been placed your orderId : "+order.getOrderId();
	}
	...
	public Integer lengthOfOrderList() {
		List<OrderList>orderList=orderListDao.findAll();
